...
var useGoogleDrivePicker = function useGoogleDrivePicker(props) {
  ...
  var _useState2 = react.useState(),
      pickerConfig = _useState2[0],
      setPickerConfig = _useState2[1];

  var oauthTokenRef = react.useRef();
...
var useFetch = function useFetch(config) {
  ...
  var handleLoadData = react.useCallback(function () {
    try {
      setLoading(true);
